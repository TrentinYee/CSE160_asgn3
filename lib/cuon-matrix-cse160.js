...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        elem3[0] = o1[1] * o2[2] - o1[2] * o2[1];
        elem3[1] = -1 * (o1[0] * o2[2] - o1[2] * o2[0]);
        elem3[2] = o1[0] * o2[1] - o1[1] * o2[0];

        let v3 = new Vector3(elem3); // Modify this line to calculate cross product between other1 and other2.
    ...
    magnitude() {
        ...
        // this could totally be done with a for loop but ok
        let m = Math.sqrt(Math.pow(d[0], 2) + Math.pow(d[1], 2) + Math.pow(d[2], 2)); // Modify this line to calculate this vector's magnitude.
